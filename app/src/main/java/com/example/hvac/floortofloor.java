...
public class floortofloor extends AppCompatActivity {
    private TextView back;
    private TextView ho,logg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floortofloor);
        ...
        on.setOnClickListener(new View.OnClickListener() {
            ...
            temp.setMessage("Water Supply is On");
